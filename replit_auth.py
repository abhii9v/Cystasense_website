...
def make_replit_blueprint():
    try:
        ...
        repl_id = 'dev-mode'  # Fallback for development

    issuer_url = os.environ.get('ISSUER_URL', "https://replit.com/oidc")
    
    # Get the correct external domain for OAuth redirect
    redirect_uri = f"https://{os.environ.get('REPLIT_DEV_DOMAIN', 'localhost:5000')}/auth/replit_auth/authorized"
        ...
        try:
            if hasattr(replit, 'token') and replit.token:
                ...
                if expires_in < 0:
                    ...
                    try:
                        repl_id = os.environ.get('REPL_ID', 'dev-mode')
            ...
            # If any token issues, continue without refreshing
            pass
